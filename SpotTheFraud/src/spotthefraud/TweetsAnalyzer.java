...
public class TweetsAnalyzer {
    ...
    */
    ...
    private void setTrends(){
        ...
        int pos = 0;
        //going all over trends (all 796 of them)
        while (cursor.hasNext() && cnt<796){
	...
	while (cursor.hasNext() && counter<12000000) { //for each tweet in the collection
            //System.out.println("---------------------------------------------------");
    ...
    /**
     * It classifies all users into 4 Categories, depending on the number of trends they appeared in
     */
       ...
       /* System.out.println("Printing all numbers:");
        ...
        if(usersCollection.isEmpty()){
            ...
            if (q1 == q2 || q2==q3){ // split in 2 groups because the split in 4 groups failed
                ...
                System.out.println("MPAKALIKAAAAAAAAAAAAAAAAAAAAAAAAAA");
